"""
Sample linear Network with linear residual blocks
"""
...
class LinearResidualBlock(nn.Module):
    """
    Architecture:
    Input -> Linear -> ReLU -> Linear + Input -> ReLU

    This residual block uses the same shape for both input and output
    """
    def __init__(self, n_features: int):
        """
        n_features (required): Number of features. Output size will always be the same as input
        """
        super().__init__()
